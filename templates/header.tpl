...
<div class="site-wrapper">
    <ul class="top-menu">
        ...
        {if $user}
            <li><span>{$user->getName()}</span>&emsp;</li>
            {else}
...
{if $h1}<h1>{$h1}</h1>{/if}
    ...
    <div class="vertical-menu">
        ...
        {foreach from=$folders_menu item=folder}
         <a {if $folder_activ.id_folder == $folder.id_folder} class="active"{/if}href="/folders/view?id_folder={$folder.id_folder}">{$folder.name_folder}</a>
         {/foreach}
    </div>
