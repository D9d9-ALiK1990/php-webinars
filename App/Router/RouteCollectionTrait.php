...
trait RouteCollectionTrait
{
    ...
    protected function parseControllerForAnnotationRoutes() {
        ...
        foreach ($files as $filePath) {
            ...
            $controllerRouters = $this->getRoutersFromControllerFile($filePath);
            $routes= array_merge($routes, $controllerRouters);
        }
        return $routes;
    }
     ...
     * @throws \ReflectionException
     */
    protected function getRoutersFromControllerFile(string $filePath) {
        $routers = [];
        ...
        foreach ($reflectionMethods as $reflectionMethod) {
            ...
            foreach ($docCommentArray as $docString) {
                ...
                $routers[$url] = [$controllerClassName, $reflectionMethod->getName()];
            }
        }
        return $routers;
    }
