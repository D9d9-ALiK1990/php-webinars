...
class Config implements ArrayAccess, Iterator {
 ...
 //       echo "<pre>"; var_dump($config); echo "</pre>"; exit;
    ...
    public static function parseConfigPath(string $configFilePath, string $replacePart = '') {
//        $a = !file_exists($configFilePath);
//        $b = !is_dir($configFilePath);
//        echo "<pre>";        var_dump($a, $b);  echo "</pre>";
